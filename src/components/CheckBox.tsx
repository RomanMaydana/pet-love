...
export const CheckBox = ({ name, label, ...rest }: Props) => {
  return (
    <label htmlFor={name} className='flex items-center gap-4 cursor-pointer w-full'>
      <div className='relative'>
        <input type="checkbox" name={name} id={name} className='peer sr-only'
          {...rest}/>
